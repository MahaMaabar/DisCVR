...
DisCVR can be downloaded from [here](http://bioinformatics.cvr.ac.uk/discvr.php). Example sample files are also available for download and a PDF version of the manual. The manual can also be found [here](https://centre-for-virus-research.github.io/DisCVR/manual). 
